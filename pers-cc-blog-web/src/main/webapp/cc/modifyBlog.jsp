...
<script type="text/javascript">
	function submitData(){
		...
		if(title==null || title==''){
			...
			$.post("${pageContext.request.contextPath}/cc/blog/save.html",{'title':title,'id':'${param.id}','blogType.id':blogTypeId,
...
<div id="p" class="easyui-panel" title="修改博客" style="padding: 10px;">
	<table cellspacing="20px">
		...
		<tr>
			...
			<td>
				<script id="editor" name="content" type="text/plain" style="height:400px;width:100%"></script>
			</td>
		</tr>
		<tr>
			<td>关键字：</td>
		...
		<tr>
			<td></td>
			<td>
				<a href="javascript:submitData()" class="easyui-linkbutton" data-options="iconCls:'icon-ok'">修改博客</a>
			</td>
		</tr>
	</table>
</div>
...
<script type="text/javascript">
    ...
    ue.addListener('ready',function(){
    	//通过ajax请求数据
    	UE.ajax.request('${pageContext.request.contextPath}/cc/blog/findById.html', 
    		{
    			method:'post',
    			async:false,
    			data:{'id':'${param.id}'},
