...
public class BlogServiceImpl implements BlogService {
    ...
    @Cacheable(value = "blog", key = "#root.target.BLOG+#id.toString()", unless = "#result eq null")
    public Blog findById(Integer id) {
        return blogRepo.findById(id);
    }

    @Override
    @CachePut(value = "blog", key = "#root.target.BLOG+#blog.id.toString()", unless = "#result eq 0")
    ...
    public Blog getLastBlog(Integer id) {
        return blogRepo.getLastBlog(id);
    }

    @Override
    @Cacheable(value = "blog", key = "#root.target.BLOG+#id.toString()", unless = "#result eq null")
    public Blog getNextBlog(Integer id) {
        return blogRepo.getNextBlog(id);
    }
    ...
    @Override
    @CacheEvict(value = "blog", key = "#root.target.BLOG+#id.toString()", condition = "#result eq 1")
    ...
    public Integer getBlogByTypeId(Integer blogTypeId) {
        return blogRepo.getBlogByTypeId(blogTypeId);
    }
