...
INSERT INTO `api_request_count` (`api_user_auth_Id`, `pond`, `api_request_count`) VALUES (`123`, RAND()*10, 1) ON DUPLICATE KEY UPDATE `api_request_count`=`api_request_count`+1
获取指定文章的总访问量的时候：
复制代码 代码如下:
